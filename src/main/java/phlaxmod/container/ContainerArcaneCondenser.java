...
public class  ContainerArcaneCondenser extends Container {
    ...
    public ContainerArcaneCondenser(int windowID, World world, BlockPos pos, PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.ARCANE_CONDENSER_CONTAINER.get(), windowID);
    ...
    public boolean stillValid(PlayerEntity playerIn) {
        return stillValid(IWorldPosCallable.create(tileEntity.getLevel(), tileEntity.getBlockPos()),
                playerIn, ModBlocks.ARCANE_CONDENSER.get());
    }
