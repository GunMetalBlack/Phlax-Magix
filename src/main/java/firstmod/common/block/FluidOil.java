...
public class FluidOil extends FlowingFluid {
	...
	public BlockState getBlockState(FluidState state) {
		return DifReg.oil_block.getDefaultState().with(FlowingFluidBlock.LEVEL, Integer.valueOf(getLevelFromState(state)));
	}

	public boolean isEquivalentTo(Fluid fluidIn) {
		return fluidIn == DifReg.oil || fluidIn == DifReg.flowing_oil;
	}
